...
<nav id="primary_nav_wrap">
    <ul>
        <li class="current-menu-item"><a href="allBooks.html">Home</a></li>
...
<div class="page-header">
    ...
    <c:forEach items="${bookInfos}" var="bookInfo">
        <tr>
            ...
            <td data-th="ISBN">${bookInfo.ISBN}</td>
            ...
            <td data-th="Lend">
                <a href="reader_lend_book_do.html?book_id=${bookInfo.book_id}" style="color: #FFFFFF">Lend</a>
            </td>
            <td data-th="Info">
                <a href="bookInfo.html?id=${bookInfo.book_id}" style="color: #FFFFFF">Info</a>
            </td>
        </tr>
    </c:forEach>
