...
<body>
<form action="<c:url value="/reader_addReaderCard_do.html"/>" method="post">
    <div class="login">
        ...
        <form>
            ...
            <br>
            <br>
            <input type="text" class="text" name="reader_id" required>
            <span>reader id</span>
            ...
            <input type="password" class="text" name="confirm_pwd" required>
